...
const RULES: string[] = [
  ...
  "Na terenie obiektu przy ul. Św. Michała 50‑56 obowiązuje ograniczenie prędkości do 5 km/h niezależnie od środka transportu; prosimy o respektowanie wymogu, gdyż nadmierna prędkość zagraża bezpieczeństwu dzieci poruszających się po całym obiekcie",
];

export default function Regulations() {
  return (
    <div className="regulations-content">
      <h3>REGULAMIN DOTYCZĄCY UCZESTNICTWA W TRENINGACH NA SALI KUZI SPORT</h3>
